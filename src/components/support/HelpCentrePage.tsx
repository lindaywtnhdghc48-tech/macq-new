  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-7 text-[var(--copy)] sm:text-base sm:leading-8">
        ...
        <ul className="space-y-2 pl-2">
          <li className="flex gap-3"><span className="mt-[10px] h-[5px] w-[5px] shrink-0 rounded-full bg-[var(--ink)]" /><span>Go to <a href="/#open-an-account" className="underline underline-offset-2 hover:text-[var(--brand)] transition">Macquarie Term Deposits</a></span></li>
